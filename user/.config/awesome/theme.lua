...
function theme.at_screen_connect(s)
    s.widgets = {
        ...
        swap = create_widget("", 2,  'sh -c "$HOME/.config/dotfiles/scripts/bar/swap.sh"'),
        ...
        screentemp = create_widget("", 15, 'sh -c "$HOME/.config/dotfiles/scripts/bar/screentemp-redshift.sh"'),
        network = create_widget("", 5, 'sh -c "$HOME/.config/dotfiles/scripts/bar/network-traffic.sh"'),
        updates = create_widget("", 60, 'sh -c "$HOME/.config/dotfiles/scripts/bar/updates.sh"'),
